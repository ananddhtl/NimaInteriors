    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Edit Blog</h4>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-2">
                                        <form action="{{ route('admin.updateblog', $blog->id ) }}" class="form-horizontal" role="form"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-2 row">
                                                <label class="col-md-2 col-form-label" for="simpleinput">Title</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="title" value="{{$blog->title}}" id="simpleinput"
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="file" name="thumbnail" class="form-control"
                                                        ...
                                                        <img height="150px;" width="200px;" src="{{ asset('admin/blog/' . $blog->image) }}">
                                                </div>
                                            </div>
