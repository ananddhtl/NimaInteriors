<div class="main-menu">
    ...
    <div data-simplebar>
        <ul class="app-menu">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="menu-item">
                            <a href="{{route('admin.itemsubgroup')}}" class="menu-link">
                                <span class="menu-text">Sub Group</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('admin.addbrand')}}" class="menu-link">
            ...
            {{-- <li class="menu-item">
                <a href="{{ route ('admin.stockmanagement')}}" class="menu-link waves-effect waves-light">
                    <span class="menu-icon"><i class="bx bx-home-smile"></i></span>
                    <span class="menu-text">Stock Management</span>
