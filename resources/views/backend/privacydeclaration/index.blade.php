    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="py-3 py-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="page-title mb-0">Add Privacy Declaration</h4>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-2">
                                        <form action="{{ route('admin.storeprivacydeclaration') }}" class="form-horizontal" role="form"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                           
                                            <div class="card-body">
                                                <h4 class="header-title">Privacy Declaration</h4>
                                                <p class="sub-header">Add privacy declaration</p>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th> <a href="{{ route('admin.editprojectdeclaration', $item->id) }}"
