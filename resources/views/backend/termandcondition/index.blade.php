        ...
        <div class="px-3">
            ...
            <div class="container-fluid">
                ...
                <div class="py-3 py-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="page-title mb-0">Edit Term and Condition</h4>
                        </div>
                        <div class="col-lg-6">
                            <div class="d-none d-lg-block">
                                <ol class="breadcrumb m-0 float-end">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Term and Condition</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="p-2">
                                            <form action="{{ route('admin.updatetermandcondition',$edittermandcondition->id) }}"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div id="snow-editor" style="height: 300px;"
                                                        ...
                                                        <div class="ql-editor" data-gramm="false" contenteditable="true">
                                                            {!! $edittermandcondition->description !!}
                                                        </div>
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <th> <a href="{{ route('admin.edittermandcondition', $item->id) }}"
