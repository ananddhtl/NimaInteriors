...
@section('content')
    ...
    @if (session('message'))
    <p>{{ 'message' }}</p> <!-- Fixed: Display the message variable instead of a string -->
    @endif
    @if (session('error'))
    <p>{{ 'error' }}</p> <!-- Display the error message if present -->
    @endif
    <section class="page">
        <!-- ***** Page Top Start ***** -->
                                ...
                                <div class="contact-form">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="fname" placeholder="Voornaam" value="{{ old('fname') }}">
                                            @if ($errors->has('fname'))
                                                <p class="error-form" >{{ $errors->first('fname') }}</p>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="lname" placeholder="Achternaam" value="{{ old('lname') }}">
                                            @if ($errors->has('lname'))
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 ">
                                            <select name="iam" class="form-select form-u" aria-label="Ik ben">
                                                ...
                                                <option value="particulars" {{ old('iam') == 'particulars' ? 'selected' : '' }}>Particulier</option>
                                                <option value="architect" {{ old('iam') == 'architect' ? 'selected' : '' }}>Architect</option>
                                                <option value="constructionpromoter" {{ old('iam') == 'constructionpromoter' ? 'selected' : '' }}>Bouwpromoter</option>
                                                <option value="others" {{ old('iam') == 'others' ? 'selected' : '' }}>Andere</option>
                                            </select>
                                            @if ($errors->has('iam'))
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 ">
                                            <select name="project" class="form-select form-u">
                                                <option disabled hidden {{ old('project') ? '' : 'selected' }}>Kies project type</option>
                                                <option value="newconstruction" {{ old('project') == 'newconstruction' ? 'selected' : '' }}>Nieuwbouw</option>
                                                <option value="renovation" {{ old('project') == 'renovation' ? 'selected' : '' }}>Renovatie</option>
                                                <option value="others" {{ old('project') == 'others' ? 'selected' : '' }}>Andere</option>
                                            </select>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="phonenumber" placeholder="Telefoonnummer" value="{{ old('phonenumber') }}">
                                            @if ($errors->has('phonenumber'))
                                                <p class="error-form" >{{ $errors->first('phonenumber') }}</p>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="streetnumber" placeholder="Straat en huis nummer" value="{{ old('streetnumber') }}">
                                            @if ($errors->has('streetnumber'))
                                                <p class="error-form" >{{ $errors->first('streetnumber') }}</p>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="pcodeandc" placeholder="Postcode en stad" value="{{ old('pcodeandc') }}">
                                            @if ($errors->has('pcodeandc'))
                                                <p class="error-form" >{{ $errors->first('pcodeandc') }}</p>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <input type="email" name="email" placeholder="E-mailadres" value="{{ old('email') }}">
                                            @if ($errors->has('email'))
                                        ...
                                        <div class="col-lg-12 text-left height: 30px; display: flex; justify-content: center; align-items: center;">
                                            <button id="submitButton" class="btn btn-c float-right" type="submit">Verzend</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
