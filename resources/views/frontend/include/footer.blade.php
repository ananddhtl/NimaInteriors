		...
		<div class="container container-footer">
			<div class="row">
				...
				<div class="col-lg-3 col-md-12 col-sm-12">
					...
					<a href="{{ asset('frontend/assets/doc/Cataloog_NimaIneriors.pdf') }}" target="_blank" class="d-flex items-alig-center justify-content-center">
			...
			<div class="row copyright text-center d-flex justify-space-between">
				<div class="text=left col-lg-3 col-md-12 col-sm-12">
				...
				<div class="text-right col-lg-9 col-md-12 col-sm-12">
					<p class="">Talen<br>
