        ...
        <div class="container-top-header">
            <div class="top-bar d-flex justify-content-between align-items-center">
                ...
                <div class="left-bar d-flex">
                    ...
                    <div class="contact-us-link d-flex align-items-center">
                        ...
                        <div class="sp-i">
                            ...
                            <p class="contact-us-top-nav ml-3 underline-with-gap"><a href=""> +32 3 296 82 66</a>
                            </p>
                ...
                <div class="right-bar d-flex">
                    ...
                    <p style="margin-left: 5px;"><a href="#"><i class=""></i>&nbsp; NL</a></p>
                </div>
            </div>
                ...
                <nav style=""class="main-nav ">
                    <div class="main-flex">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="/shop" id="shop-link">Winkelwagen <i class="fa fa-shopping-basket"></i></a>
                            </li>
                            @if (auth()->check())
                                <li style="text-color:black;">
                                    <a href="/user/profile">{{ auth()->user()->fullname }}</a>
                                </li>
                                <li>
