...
Route::group(["prefix" => "admin", "as" => "admin."], function () {
    ...
    Route::get('editprivacydeclaration/{id}', [PrivacyDeclarationController::class, 'edit'])->name('editprivacydeclaration');
    Route::post('updateprivacydeclaration/{id}', [PrivacyDeclarationController::class, 'update'])->name('updateprivacydeclaration');
});
